        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a href="mailto:support@spa-pregio.com"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.ambassadors.map((link) => (
                <li key={link.name}>
                  {link.external ? (
                    <a href={link.href} target="_blank" rel="noopener noreferrer" className="text-spa-gray hover:text-spa-purple transition-colors duration-200">{link.name}</a>
                  ) : (
                    <Link to={link.href} className="text-spa-gray hover:text-spa-purple transition-colors duration-200">{link.name}</Link>
                  )}
                </li>
